...
%     *****************************************************************
      ...
      [deltai1, deltava, deltavb, dttu, gam1, gam2] = combined( rinit, rfinal, einit, efinal, nuinit, nufinal, deltai );
      ...
      [r3,v3] = coe2rv(ptran,   etran, 28.5/rad+deltai1, 45.0/rad, 180.0/rad, 180.0/rad, 0.0/rad, 0.0, 0.0);
      [r4,v4] = coe2rv(rfinal*re, 0.0, 90.0/rad,         45.0/rad, 180.0/rad, 180.0/rad, 0.0/rad, 0.0, 0.0);
